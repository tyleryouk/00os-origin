...
This file defines the specific operation of the `dev-mode: rules-workflow @parameters/rules/dev-mode-performance.mdc` message-command, which initializes developer mode with a focus on performance optimization implementation. It should be consulted to understand:
...
When the `dev-mode: rules-workflow @parameters/rules/dev-mode-performance.mdc` message-command is received, 1000xdev will:
