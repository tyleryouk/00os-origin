...
1.  **Syntax Verification**: 
    *   **Action**: Automatically review each tool call line against the known schemas and `1000xrules/core/tools/tool-usage-standards.mdc`.
    ...
    *   **Reference**: `1000xbrain/brain/knowledge/commands/command-structure.md`.

2.  **Structural Verification**: 
    *   **Action**: Automatically review the overall file structure.
    *   **Checks**: Single H1 header on the first line, only tool calls and optional comments follow, correct file location and naming (`1000xbrain/commands/domain/name.md`).
    *   **Reference**: `1000xbrain/brain/knowledge/commands/command-structure.md`, `1000xbrain/brain/knowledge/commands/directory-organization.md`.
...
Steps 1-4 are integrated into the standard `creation-process.md` (now at `1000xbrain/brain/knowledge/commands/creation-process.md`) that 1000xdev follows when creating a new command.
...
1.  **Manual Review**: Tyler Youk reviews the created `.md` command file in `1000xbrain/commands/`.
2.  **Trial Invocation**: Tyler Youk invokes the command (using the `` `run command:domain/name` `` syntax) in a controlled context.
