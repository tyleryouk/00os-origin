...
| **Manual** | When explicitly referenced | Provides on-demand specialized knowledge | knowledge/rules/patterns/tool/search-patterns.md |
...
├── knowledge/rules/                 # Domain knowledge
