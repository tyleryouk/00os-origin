...
|------|-------------|------------------|
| [Tool Patterns](#tool-patterns) | Reusable patterns for tool usage | `knowledge/rules/patterns/tool/` |
| [Tool References](#tool-references) | Detailed tool documentation | `knowledge/rules/reference/guides/` |
| [Tool Combinations](#tool-combinations) | Effective tool sequences | `knowledge/rules/patterns/tool/combinations.md` |
| [Best Practices](#best-practices) | Optimized usage guidelines | `knowledge/rules/reference/guides/tool-best-practices.md` |
