...
This guide works in conjunction with the comprehensive [Common-Words Registry](../architecture/common-words-reference.md), which provides a concise registry of all standardized terms. Use this guide for detailed explanations, usage contexts, and examples, while referring to the Common-Words Registry for quick reference and complete term listing.
...
### Message-Command Terminology

| Standardized Term | Definition | Usage Context | Example |
|------------------|------------|---------------|---------|
| **message-command** | Command to initiate a specific workflow mode | Primary term for commands | "Use a message-command to initiate the workflow" |
| **five-component-structure** | Standard message-command with five components | When discussing format | "Follow the five-component-structure for all message-commands" |
| **pathway-name** | Component specifying implementation pathway | When discussing components | "Specify the pathway-name as the third component" |
| **none-placeholder** | Explicit "none" text used for position | When discussing syntax | "Use the none-placeholder for unused components" |
| **space-delimited-syntax** | Message-command syntax using spaces | When discussing format | "The space-delimited-syntax separates all components" |

### Mode System Terminology

| Standardized Term | Definition | Usage Context | Example |
|------------------|------------|---------------|---------|
| **mode-system** | Framework for separating planning and implementation phases | When discussing system | "The mode-system organizes tasks into discrete phases" |
| **plan-mode** | Documentation and planning phase | When discussing modes | "In plan-mode, focus on documentation creation" |
| **dev-mode** | Code implementation phase | When discussing modes | "In dev-mode, implement solutions from planning" |
| **direct-mode** | Immediate implementation phase | When discussing modes | "Use direct-mode for simple, immediate tasks" |
| **mode-indicator** | Emoji + identity + workflow-type | When discussing indicators | "Begin with the mode-indicator matching your current mode" |

### Relationship Terminology

| Standardized Term | Definition | Usage Context | Example |
|------------------|------------|---------------|---------|
| **brain-file-cursor-rule-relationship** | The direct connection between source files and applied rules | Primary term for the relationship | "The brain-file-cursor-rule-relationship is central to AI cognition" |
...
|------|------------|--------------|
| **core-subsystem** | Essential identity and mode system components | "The core-subsystem defines fundamental capabilities" |
...
| Term | Definition | Example Usage |
|------|------------|--------------|
| **workflow-subsystem** | Process-specific implementation patterns | "The workflow-subsystem contains domain-specific patterns" |
...
| **scripts-workflow** | Process for implementing utility scripts | "The scripts-workflow guides automation development" |

### Knowledge Subsystem Terminology

| Term | Definition | Example Usage |
|------|------------|--------------|
| **knowledge-subsystem** | Specialized domain knowledge components | "The knowledge-subsystem contains implementation patterns" |
...
| Term | Definition | Example Usage |
|------|------------|--------------|
| **file-hierarchy** | Organization structure of brain-files and cursor-rules | "The file-hierarchy ensures easy navigation" |
| **directory-structure** | Physical organization of files in the repository | "The directory-structure supports cognitive function" |
| **cognitive-loop** | Perception-reasoning-action-learning process cycle | "The cognitive-loop enables continuous improvement" |
| **knowledge-hierarchy** | Organizational structure of knowledge components | "The knowledge-hierarchy organizes specialized information" |
| **parameter-hierarchy** | Organizational structure of project-rule-parameters | "The parameter-hierarchy ensures efficient access" |
...
7. **Update Process**: Add new terms to the Common-Words Registry when created
...
```
message-command: @parameters/reference/guides/terminology-standards.mdc
```

## Related References

- Common-Words Registry: `knowledge/rules/reference/architecture/common-words-reference.md`
...
- Symbol Usage Guide: `knowledge/rules/reference/guides/symbol-usage.md`
