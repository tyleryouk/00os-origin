...
```typescript
fetch_rules(["knowledge/category/component"], 
...
```typescript
fetch_rules([
  "knowledge/category1/component1",
  "knowledge/category2/component2"
...
fetch_rules(["knowledge/reference/domains/tool"], 
...
fetch_rules([
  "knowledge/patterns/impl/implementation-patterns",
  "knowledge/patterns/doc/basic-patterns"
...
❌ **Avoid**:
```typescript
fetch_rules(["guides/architecture"])  // Missing knowledge/ prefix
fetch_rules(["knowledge/guides-architecture"])  // Incorrect path format
```
...
grep_search("knowledge/guides/architecture.*USE WHEN")
