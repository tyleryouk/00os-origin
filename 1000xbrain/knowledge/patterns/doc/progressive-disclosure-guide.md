...
This file is part of the documentation patterns in the knowledge/patterns/doc directory and complements the information-chunking-guide.md, hierarchical-relationship-guide.md, reference-architecture-guide.md, and standard-file-template.md.
