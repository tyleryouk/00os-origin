...
This file is part of the documentation patterns in the knowledge/patterns/doc directory and complements the reference-architecture-guide.md which provides broader reference architecture strategies.
...
- Knowledge Component: `fetch_rules(["knowledge/guides/architecture"])`
```
