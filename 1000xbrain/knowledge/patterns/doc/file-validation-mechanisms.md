...
This file is part of the documentation patterns in the knowledge/patterns/doc directory and complements the file-operation-boundaries.md, context-preservation-mechanisms.md, and hierarchical-relationship-guide.md files.
...
const templateAdherenceResult = validateTemplateAdherence(
  fileContent, 
  'knowledge/patterns/doc/templates/pattern-template.md'
);
```
...
const validationResult = validateFile(
  'knowledge/patterns/doc/new-pattern.md',
  'knowledge-patterns'
);
```
