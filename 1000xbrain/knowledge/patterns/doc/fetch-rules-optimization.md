...
This file is part of the documentation patterns in the knowledge/patterns/doc directory and complements the reference-architecture-guide.md, reference-format-template.md, and direct-reference-patterns.md.
...
```typescript
fetch_rules(["knowledge/path/to/component"], 
...
fetch_rules(["knowledge/reference/architecture/file-structure"], 
...
fetch_rules(["knowledge/guides/rules-workflow"], 
...
```typescript
// INSTEAD OF:
// fetch_rules(["knowledge/reference/complete-guide"], "Understanding everything")
...
fetch_rules(["knowledge/patterns/impl/symbol-handling"], 
...
```typescript
// INSTEAD OF:
// fetch_rules(["knowledge/patterns/impl/error-handling"], "Understanding error handling")
// fetch_rules(["knowledge/patterns/impl/validation"], "Understanding validation")
// fetch_rules(["knowledge/patterns/impl/verification"], "Understanding verification")

// OPTIMIZED VERSION:
fetch_rules([
  "knowledge/patterns/impl/error-handling",
  "knowledge/patterns/impl/validation",
  "knowledge/patterns/impl/verification"
...
// fetch_rules(["knowledge/patterns/impl/searching"], "Search implementation")
// fetch_rules(["knowledge/patterns/impl/parsing"], "Parse implementation")
// fetch_rules(["knowledge/patterns/impl/rendering"], "Render implementation")

// OPTIMIZED VERSION:
// Single call with all needed implementation knowledge
fetch_rules([
  "knowledge/patterns/impl/searching",
  "knowledge/patterns/impl/parsing",
  "knowledge/patterns/impl/rendering"
...
fetch_rules([
  ...
  "knowledge/guides/file-structure"
], "Understanding system architecture for analysis phase")

// PLANNING PHASE
fetch_rules([
  "knowledge/patterns/impl/implementation-planning",
  "knowledge/patterns/impl/approach-selection"
], "Planning implementation approach based on established patterns")

// IMPLEMENTATION PHASE
fetch_rules([
  "knowledge/patterns/impl/code-patterns",
...
fetch_rules(["knowledge/patterns/impl/validation"], 
...
fetch_rules([
  ...
  "knowledge/reference/architecture/core-architecture",
  
  // Workflow level next
  "knowledge/reference/architecture/workflow-architecture",
...
fetch_rules([
  ...
  "knowledge/reference/guides/validation-guide"
...
fetch_rules([
  ...
  "knowledge/reference/frameworks/message-command-framework",
  
  // Implementation patterns for the framework
  "knowledge/patterns/impl/message-command-patterns",
  
  // Validation patterns for the framework
  "knowledge/patterns/impl/message-command-validation"
...
fetch_rules([
  "knowledge/reference/architecture",
  "knowledge/patterns/impl/implementation-patterns",
  "knowledge/patterns/tool/tool-combinations",
...
fetch_rules(["knowledge/guides/verification"], 
...
// INSTEAD OF:
// fetch_rules([
//   "knowledge/reference/complete-guide",
//   "knowledge/patterns/all-patterns",
//   "knowledge/guides/comprehensive-guide"
// ], "Complete understanding")

// OPTIMIZED VERSION:
fetch_rules(["knowledge/patterns/impl/specific-pattern"], 
...
```typescript
// INSTEAD OF:
// fetch_rules(["knowledge/patterns/tool/search-patterns"], "Finding implementation examples")
// fetch_rules(["knowledge/patterns/impl/implementation-patterns"], "Implementing found examples")
...
// fetch_rules(["knowledge/patterns/tool/search-patterns"], "Search phase")
// [search code]
// fetch_rules(["knowledge/patterns/impl/analysis-patterns"], "Analysis phase")
// [analysis code]
// fetch_rules(["knowledge/patterns/impl/implementation-patterns"], "Implementation phase")
// [implementation code]

// OPTIMIZED VERSION - preload complete workflow:
fetch_rules([
  "knowledge/patterns/tool/search-patterns",
  "knowledge/patterns/impl/analysis-patterns",
  "knowledge/patterns/impl/implementation-patterns"
...
fetch_rules([
  ...
  "knowledge/patterns/tool/command-patterns",
  "knowledge/patterns/impl/implementation-patterns",
  "knowledge/patterns/doc/validation-patterns"
...
// fetch_rules(["knowledge/patterns/tool/search-patterns"], "Search")
// fetch_rules(["knowledge/reference/architecture"], "Architecture")
// fetch_rules(["knowledge/patterns/impl/implementation-patterns"], "Implementation")
...
fetch_rules([
  "knowledge/patterns/tool/search-patterns",
  "knowledge/patterns/impl/specific-feature-patterns"
...
// fetch_rules(["knowledge/reference/architecture/complete"], "Understanding architecture")
// fetch_rules(["knowledge/reference/architecture/complete", "knowledge/patterns/impl/all-patterns"], "Implementation")

// OPTIMIZED VERSION - progressive disclosure:
// Start with core knowledge
fetch_rules(["knowledge/reference/architecture/core"], "Understanding core architecture concepts")
