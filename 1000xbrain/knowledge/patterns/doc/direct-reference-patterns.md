...
This file is part of the documentation patterns in the knowledge/patterns/doc directory and complements the reference-architecture-guide.md and reference-format-template.md.
...
`knowledge/guides/architecture.md`                         # System architecture guide
`knowledge/patterns/impl/implementation-patterns.md`       # Implementation patterns
```
