...
```
fetch_rules(["knowledge/reference/architecture/modes", "knowledge/reference/architecture/message-commands"], 
...
```
fetch_rules(["knowledge/reference/architecture/file-safety", "knowledge/reference/architecture/identity"], 
...
```
fetch_rules(["knowledge/reference/architecture/knowledge-access", "knowledge/reference/maps/domain-map"], 
...
- Simplified Message-Commands: `fetch_rules(["knowledge/guides/simplified-message-commands"])` 