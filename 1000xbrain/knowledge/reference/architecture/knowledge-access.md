...
```typescript
fetch_rules(["knowledge/path/to/component"], "Explanation of why accessing")
```
...
4. **Be Specific with Knowledge Paths**: Use specific paths to access relevant knowledge
   ...
   fetch_rules(["knowledge/patterns/impl/front-end-patterns"],
              "Understanding front-end implementation patterns")
   
   // Specific path for back-end patterns
   fetch_rules(["knowledge/patterns/impl/back-end-patterns"],
...
|----------|------|---------|---------|
| Architecture | knowledge/guides/architecture | Understanding system architecture | fetch_rules(["knowledge/guides/architecture"], "Understanding system structure") |
| Implementation | knowledge/patterns/impl/* | Patterns for implementation | fetch_rules(["knowledge/patterns/impl/implementation-patterns"], "Finding implementation patterns") |
| Tool Usage | knowledge/patterns/tool/* | Patterns for tool usage | fetch_rules(["knowledge/patterns/tool/search-patterns"], "Optimizing search strategies") |
| Documentation | knowledge/patterns/doc/* | Patterns for documentation | fetch_rules(["knowledge/patterns/doc/file-standards"], "Understanding documentation standards") |
| Reference | knowledge/reference/* | Reference information | fetch_rules(["knowledge/reference/architecture"], "Understanding architectural references") |
...
```typescript
fetch_rules(["knowledge/patterns/tool/research-patterns"],
...
1. **Different Access Method**: 
   - Knowledge: `fetch_rules(["knowledge/path"], "Explanation")`
