...
## Complete Original Request Content
...
2. This system should standardize the 7-step sequential command pattern across all domains
3. After consultation, "cycle-manager" has been chosen as the preferred name
4. The directory structure will be:
