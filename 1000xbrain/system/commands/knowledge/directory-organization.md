...
This document outlines the mandatory directory structure for organizing `1000xcommand` definition files (`.md` files) within the system. Proper organization is essential for clarity, maintainability, and correct invocation.
...
*   **`brain/`**: Commands related to enhancing or analyzing the `1000xbrain` cognitive architecture itself.
    *   *Example*: `1000xcommands/brain/analyze-knowledge-structure.md`

*   **`frontend/`**: Commands specifically for front-end development tasks within the `/front-end` project directory.
    *   *Example*: `1000xcommands/frontend/refactor-component-props.md`

*   **`backend/`**: Commands specifically for back-end development tasks within the `/back-end` project directory.
    *   *Example*: `1000xcommands/backend/add-database-migration.md`

*   **`rules/`**: Meta-commands related to managing the `1000xrules` *core* rules system.
    *   *Example*: `1000xcommands/rules/create-new-core-rule.md`

*   **`scripts/`**: Commands related to developing or managing automation scripts within the `/1000xscripts` directory.
    *   *Example*: `1000xcommands/scripts/run-sync-script-dry-run.md`
...
## Invocation Path Syntax

The invocation syntax used by Tyler Youk directly mirrors this structure:
...
*   **Invocation Accuracy**: Correct resolution of command references via `read_file` using the explicit path.
...
*   `1000xbrain/brain/knowledge/commands/command-structure.md`: File format requirements. 