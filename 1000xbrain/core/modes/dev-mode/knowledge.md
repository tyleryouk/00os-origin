...
2. **Access Domain Knowledge**:
   ```typescript
   fetch_rules(["knowledge/reference/domains/implementation"],
...
|----------|---------|----------------|
| Implementation Patterns | Code structure and organization | `knowledge/patterns/impl/*` |
| Tool Patterns | Efficient tool usage | `knowledge/patterns/tool/*` |
| Domain Knowledge | Technical requirements | `knowledge/reference/domains/*` |
| Architecture | System structure | `knowledge/reference/architecture/*` |
...
2. **Access Domain-Specific Patterns**:
   ```typescript
   fetch_rules(["knowledge/patterns/impl/domain-patterns"],
              "Understanding domain-specific patterns")
   ```

3. **Access Tool Patterns**:
   ```typescript
   fetch_rules(["knowledge/patterns/tool/implementation-tools"],
...
1. **Access Error Patterns**:
   ```typescript
   fetch_rules(["knowledge/patterns/impl/error-patterns"],
              "Understanding error resolution patterns")
   ```

2. **Access Debug Tools**:
   ```typescript
   fetch_rules(["knowledge/patterns/tool/debug-tools"],
...
2. **Access Pattern Knowledge**:
   ```typescript
   fetch_rules(["knowledge/patterns/impl/pattern-selection"],
...
|-------------|----------|------------------|
| Basic | Common implementations | `knowledge/patterns/impl/basic-patterns` |
| Domain | Specific features | `knowledge/patterns/impl/domain-patterns` |
| Tool | Tool usage | `knowledge/patterns/tool/tool-patterns` |
| Error | Problem resolution | `knowledge/patterns/impl/error-patterns` | 