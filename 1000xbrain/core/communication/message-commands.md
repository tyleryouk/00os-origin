...
The simplified system uses a standardized space-delimited format with five components, with NO COLONS between components:
...
Each message-command has five standardized components:
