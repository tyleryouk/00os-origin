Prompts to turn to 00OS commands (eventually)

All these prompts are utilized when talking to the AI identity 1000xdev


1000xdev, read all files in [back-end-folder-filepath]. Read-only, do not edit any files.

1000xdev, append a section to [context-folder-filepath] describing the folder [back-end-folder-filepath].



1000xdev, append a section to 1000xdev\steam-integration\context-back-end-api.md describing the folder [back-end-folder-filepath].
