...
### Created Files
Created: state-manager.md -> .cursor/rules\core\state-manager.mdc
Created: counter.md -> .cursor/rules\processes\examples\counter.mdc
Created: state.md -> .cursor/rules\processes\system\state.mdc
