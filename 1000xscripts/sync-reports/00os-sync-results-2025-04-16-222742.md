...
### Created Files
Created: chain.md -> .cursor/rules\processes\system\chain.mdc
Created: system-monitor.md -> .cursor/rules\processes\tools\system-monitor.mdc
