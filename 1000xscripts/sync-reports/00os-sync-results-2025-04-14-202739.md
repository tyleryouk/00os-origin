...
### Created Files
Created: 00os-integration.md -> .cursor/rules\core\00os-integration.mdc
Created: setup-script.md -> .cursor/rules\core\setup-script.mdc
Created: reaper-read-files.md -> .cursor/rules\processes\system\reaper-read-files.mdc
