...
description: Reads the current requirements, plan, and status from the three core workflow files (active-request.md, implementation-plan.md, cycle-status.md) in 00reaper/ and executes the necessary changes to 00OS process files and tracking documents.
version: 4.0.0
category: 00reaper
author: 00reaper
