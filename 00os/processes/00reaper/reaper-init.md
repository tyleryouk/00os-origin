...
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/README.md',
  should_read_entire_file: true,
  explanation: 'Load workflow README'
});
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/active-request.md',
  should_read_entire_file: true,
  explanation: 'Load active request'
});
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/implementation-plan.md',
  should_read_entire_file: true,
  explanation: 'Load implementation plan'
});
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/cycle-status.md',
  should_read_entire_file: true,
...
```javascript
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/user-directed/final-goal.md',
  should_read_entire_file: true,
  explanation: 'Load final goal document'
});
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/user-directed/00OS-simplification-roadmap.md',
  should_read_entire_file: true,
...
```javascript
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/documentation/command-template-core.md',
  should_read_entire_file: true,
  explanation: 'Load command template'
});
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/documentation/command-standards-core.md',
  should_read_entire_file: true,
...
```javascript
await tools.call('read_file', {
  target_file: '00reaper/00OS-commands/context-00OS-current-state/core.md',
  should_read_entire_file: true,
