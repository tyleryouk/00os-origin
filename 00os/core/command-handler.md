...
async function processCommand(input) {
  ...
  try {
    ...
    // CRITICAL STEP: Fetch the rule for the determined process
    // Remove the extension from the process rule name (fetch_rules expects no extension)
    ...
    try {
        ...
        return {
          ...
          processRule: ruleNameWithoutExt
        };
    } catch (fetchError) {
