# USE WHEN implementing validation scripts, verifying project-rule-parameters, or automating reference checks

# Validation Script Patterns

## Overview
This document provides implementation patterns for creating validation scripts that check for correct project-rule-parameter references throughout the 1000xbrain cognitive architecture.

## Key Patterns

### Pattern 1: Basic Parameter Validation Script
...
### Pattern 2: Enhanced Validation with README Checking
...
### Pattern 3: Comprehensive Validation Process
...
### Pattern 4: README.md Header Validation
...
When implementing validation scripts, follow these steps:

1. **Define Validation Scope**: Determine what aspects need validation (references, formats, headers)
2. **Implement Detection Logic**: Create functions to detect issues using regex patterns
3. **Implement Reporting Logic**: Format and output validation results clearly
4. **Integrate with Workflows**: Add the validation to relevant workflows
5. **Document Validation Results**: Create clear documentation for validation outputs

## Usage Guidance

Validation scripts should be used:

1. **During Development**: As a regular check during development
2. **Before Committing Changes**: To verify changes maintain system integrity
3. **In CI/CD Processes**: As part of automated testing and deployment

## Common Implementation Pitfalls

When implementing validation scripts, avoid these common issues:

1. **Over-Specific Regex**: Too specific regex patterns may miss valid variations
2. **Performance Issues**: Inefficient validation may slow down workflows
3. **False Positives**: Incorrect validation logic may flag valid structures
4. **Incomplete Validation**: Missing checks for important validation criteria

## Related Patterns
- Scanning Automation Patterns: `knowledge/rules/patterns/impl/scanning-automation-patterns`
- Validation Logic Patterns: `knowledge/rules/patterns/impl/validation-logic`
- Error Handling Patterns: `knowledge/rules/patterns/impl/validation-error-handling`

## Conclusion
Effective validation script patterns ensure the integrity of the 1000xbrain cognitive architecture by systematically checking references, file structures, and documentation standards. Proper implementation of these patterns helps prevent inconsistencies and maintains system reliability. 