...
```
knowledge/rules/[category]/[subcategory]/[component-name]
```
...
```
knowledge/rules/guides/architecture: USE WHEN understanding system architecture, working with cognitive components, or learning about brain-files and cursor-rules
knowledge/rules/patterns/tool/search-patterns: USE WHEN implementing search functionality, finding code in the codebase, or optimizing search tool usage
knowledge/rules/reference/architecture: USE WHEN learning about system organization, understanding architectural components, or referencing system structure
```
...
```typescript
fetch_rules([
  "knowledge/rules/guides/rules-workflow",
  "knowledge/rules/patterns/impl/rules-workflow-patterns",
  "knowledge/rules/reference/architecture/rules-workflow-architecture"
