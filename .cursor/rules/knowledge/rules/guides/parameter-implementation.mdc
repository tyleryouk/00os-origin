...
- Parameter template in knowledge/rules/patterns/doc/templates/parameter-template.md
...
- `knowledge/rules/guides/parameter-standardization` for parameter standardization guidelines
