...
|---------------|----------------|------------|------------------|
| Reference | Knowledge retrieval | Comprehensive information | knowledge/rules/reference/ |
| Guide | Process explanation | Step-by-step guidance | knowledge/rules/guides/ |
| Pattern | Implementation practices | Reusable solutions | knowledge/rules/patterns/ |
| Index | Navigation assistance | Organization & discovery | knowledge/rules/reference/ |
| Map | Relationship visualization | Connections & structure | knowledge/rules/reference/maps/ |
