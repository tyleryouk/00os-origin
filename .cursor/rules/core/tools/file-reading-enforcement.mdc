...
*   Core Standards: `core/core-essentials.md`
*   Implementation Patterns: `knowledge/rules/patterns/tool/file-reading-patterns.md`

## CRITICAL: This is a CORE directive

This mandatory 3-step process defines the authoritative procedure for file reading. 