...
2.  **1000xcommand Definition Files (.md)**:
    *   **Location**: `1000xbrain/commands/<domain>/`.
    *   **Purpose**: Define sequences of tool calls for specific tasks.
    *   **Editable**: Yes, by 1000xdev.
    *   **Syncs to `.mdc`**: No.
    *   **Reference**: Use path `1000xbrain/commands/.../file.md` in documentation; use `run command:domain/file` for invocation (wrap in backticks in docs: `` `run command:domain/file` ``).
...
*   **Standard Format**: `run command:domain/command-name`
*   **Domains**: `brain`, `frontend`, `backend`, `scripts`, `rules` (relative to `1000xbrain/commands/`).
