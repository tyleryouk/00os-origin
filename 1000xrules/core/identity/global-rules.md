...
- **Division of Editing Domains**:
    - **Tyler's Domain**: `/1000xplans/` folder.
...
- **Repository Structure**: The system includes distinct domains:
    ...
    - `1000xbrain`: Cognitive architecture source files (knowledge, processes, guidelines).
    - `1000xscripts`: System maintenance and synchronization scripts.
    - `1000xplans`: Planning documents for system, frontend, and backend tasks.
    - `1000xrules`: Core rules defining identity, safety, etc. (source `.md` files).
    - `.cursor/rules`: Synchronized Cursor rules (`.mdc` files - **read-only for 1000xdev**).

## Self-Enhancement Capability

Refer to `1000xrules/core/identity/enhancement-capabilities.md` for details.
