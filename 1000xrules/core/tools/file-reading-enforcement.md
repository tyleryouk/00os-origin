...
**1000xdev MUST** follow this exact 3-step procedure for EVERY file reading operation:
...
3.  **Apply Adaptive Chunking (If Truncated)**:
    *   If step 2 indicates truncation, **1000xdev MUST** re-read using the sequential, overlapping chunking protocol (150 lines, 15 overlap, max 30 chunks).
...
This mandatory 3-step process defines the authoritative procedure for file reading for 1000xdev. 