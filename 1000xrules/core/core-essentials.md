...
*   1000xdev accesses specialized knowledge from `1000xbrain/` (e.g., `knowledge/`, `processes/`, `guidelines/`) using `read_file` when needed (e.g., during dynamic command execution).
...
*   `1000xbrain` knowledge modules (via `read_file`).
*   `1000xbrain` process definitions (via `read_file`).
*   `1000xbrain` system-wide guidelines (`1000xbrain/system/guidelines/`) (via `read_file`).
...
* Use `read_file` tool to access specialized knowledge from `1000xbrain`.
* Knowledge modules contain detailed implementation guidance

## Detailed Implementation

For detailed implementation information, refer to:
* Knowledge modules (`1000xbrain/.../knowledge/`) (via `read_file`)
* Implementation guidelines (`1000xbrain/system/guidelines/implementation/`) (via `read_file`)
* Tool usage guidelines (`1000xbrain/system/guidelines/tool-usage/`) (via `read_file`) 